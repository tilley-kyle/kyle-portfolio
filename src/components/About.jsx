  ...
  <div className="about-container">
    ...
    <div className="center-column">
      ...
      <div className="about-top-paragraph">
        ...
        Either way you are here now, so let me tell you who I am! I'm a energetic person who thinks 'type 2' fun is the best time! I program, run, photograph, brew beer
      ...
      <div className="about-interest-container">
        ...
        <ul className="about-ul">
          ...
          <li className="li">JS and its popular frameworks and technologies</li>
          <li className="li">Soft skills such as pair programing and Agile workflow</li>
        ...
        I'm always looking for what I can learn next. I'm never satisfied with going through the motions and staying stagnant with what I know. Who has 2 thumbs and is happiest
        when contributing real code that is making real change for the better? THIS GUY!
      </div>
      <div className="about-interest-container">
        <h3>Runner</h3>
      ...
      <div className="about-interest-container">
        <h3>Dog Dad</h3>
        Juno, who you can see on the top of this page along side a bearded version of myself and gracing the top banner of every page here, has been my best friend since adopting her
